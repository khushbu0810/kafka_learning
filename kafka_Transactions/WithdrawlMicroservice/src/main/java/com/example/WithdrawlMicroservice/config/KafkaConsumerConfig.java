package com.example.WithdrawlMicroservice.config;


import com.example.coreModule.error.NotRetryableException;
import com.example.coreModule.error.RetryableException;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String,Object> consumerFactory(){
        ...
        ConConfig.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,environment.getProperty("spring.kafka.consumer.bootstrap-servers"));
        ...
        ConConfig.put(ConsumerConfig.GROUP_ID_CONFIG,environment.getProperty("consumer.group-id"));
        ConConfig.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG,environment.getProperty("spring.kafka.consumer.isolation-level","READ_COMMITED").toLowerCase());
